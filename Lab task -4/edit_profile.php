				...
				<td width="75%">
					<fieldset>
						...
						<form method="post" action="">
								...
								(dd/mm/yyyy)
								<br><br>
								<input type="text" name="day" value="<?= $_SESSION['user']['dateOfBirth']['day']?>">
								<input type="text" name="month" value="<?= $_SESSION['user']['dateOfBirth']['month']?>">
								<input type="text" name="year" value="<?= $_SESSION['user']['dateOfBirth']['year']?>">
								<br>
