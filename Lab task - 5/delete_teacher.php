			...
			<tr>
				<td width="25%">
					...
					<ul style="list-style-type:disc;">
						...
						<li><a href="view_notice.php">View Notice List</a></li>
				...
				<td width="75%">
					<fieldset>
						...
						<form method="post" action="">
								...
								<input type="text" name="fname" value="<?=$name?>" readonly><span style="color: red;"><?php echo $nameErr ?></span>
								<hr>
							

								
								<legend>Email</legend>
								<input type="text" name="email" value="<?=$email?>" readonly><span style="color: red;"><?php echo $emailErr ?></span>
								<hr>
								...
								(dd/mm/yyyy)
								<br><br>
								<input type="text" name="day" value="<?= $day?>"readonly>
								...
								<input type="button" onclick="window.location = 'confirm_delete.php?id=<?=$id?>'" value="Delete">
